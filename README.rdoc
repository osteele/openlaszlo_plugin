...
== Installation (Rails 2.3 or later)
...
a starter applet that's served from <tt>/home/applet</tt>, do one of:
  generate=true rails webapp -m http://gist.github.com/83809.txt
  generate=true rake rails:template LOCATION=http://gist.github.com/83809.txt
...
you will probably want to put this in your <tt>.bashrc</tt> or <tt>.profile</tt>).
The second line of shell script will tell you whether you've set it right.
